          ...
          <div className="flex flex-wrap">
              ...
              <form className="max-w-md" onSubmit={submitForm}>
                <div className="mb-4">
                  ...
                  <input
                    ...
                    id="name"
                    name="name"
                    className="form-input mt-1 block w-full bg-black focus:border-transparent outline-none p-3"
                    value={formData.name}
                ...
                <div className="mb-4">
                  ...
                  <textarea
                    ...
                    name="message"
                    rows={4}
                    className="form-textarea mt-1 block w-full bg-black focus:border-transparent outline-none p-3"
            ...
            <div className="w-full md:w-1/2 px-2 md:px-4 mb-4">
              ...
              <div className="flex items-center mb-4">
                ...
                <a href="https://github.com/maxKevin" className="text-gray-400">
                  github.com/maxKevin
                </a>
              </div>
              <div className="flex items-center">
                <DownloadIcon className="text-gray-400 mr-4" size={24} />
                <a href="/myresume.pdf" download className="text-gray-400">
                  Download Resume
                </a>
              </div>
            </div>
