...
export const dataAboutPage = [
  {
    ...
    subtitle: "Unifarm",
    description:
      "Integrated AMM with gasless logic on Shardeum network based on Uniswap SDK and developed IDO and token bridge smart contract for integrating cross-chain",
    date: "Oct 2022",
  },
  {
    id: 2,
    ...
    subtitle: "Rebate",
    description:
      "Build dApp implementing DEX on Ethereum using Solidity and also the crypto investment platform using React on Ethereum network.",
    date: "Oct 2021",
  },
  {
    id: 3,
    ...
    description:
      "Developed RESTful APIs for music/video commerce web app using Django-Rest-Framework and reviewed the pull requests submitted from other front-end developers.",
    date: "Sep 2020",
  },
  {
    id: 4,
